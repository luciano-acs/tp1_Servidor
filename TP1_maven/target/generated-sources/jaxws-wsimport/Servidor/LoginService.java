 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://istp1service.azurewebsites.net/LoginService.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://istp1service.azurewebsites.net/LoginService.svc?wsdl");
     ...
     */
    @WebEndpoint(name = "SGEAuthService")
    public ILoginService getSGEAuthService() {
        return super.getPort(new QName("http://tempuri.org/", "SGEAuthService"), ILoginService.class);
    }
     ...
     */
    @WebEndpoint(name = "SGEAuthService")
    public ILoginService getSGEAuthService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "SGEAuthService"), ILoginService.class, features);
    }
